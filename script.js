...
const translations = {
  en: {
    ...
    "sidebar.download": "Dev Download",
    "sidebar.contributors": "Contributors",
    "contributors.founder": "Founder",
    "contributors.modelers": "Modelers",
    "contributors.coder": "Coder",
  ...
  ru: {
    ...
    "sidebar.contributors": "Участники",
    "contributors.founder": "Основатель",
    "contributors.modelers": "Моделлеры",
    "contributors.coder": "Программист",
  ...
  ja: {
    ...
    "sidebar.download": "開発者向けダウンロード",
    "sidebar.contributors": "貢献者",
    "contributors.founder": "創設者",
    "contributors.modelers": "モデラー",
    "contributors.coder": "プログラマー",
