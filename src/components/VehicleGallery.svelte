<script>
  ...
  const available3DModels = {
    ...
    'F-14': '/AshVehicle-site/models/f-14.gltf',
  ...
  const vehicles = {
    ...
    fighters: [
      { name: "Su-34", status: "added" },
      { name: "Su-33", status: "added" },
      { name: "Su-25", status: "added" },
      { name: "Su-27", status: "added" },
      { name: "Mig-29", status: "added" },
      { name: "F-4", status: "added" },
      { name: "JAS39E", status: "added" },
      { name: "F-35", status: "added" },
      { name: "F-22", status: "added" },
      { name: "F-117", status: "added" },
      { name: "F-18", status: "added" },
      { name: "F-2", status: "added" },
      { name: "F-15", status: "added" },
      { name: "Su-57", status: "added" },
      { name: "F-16", status: "added" },
      { name: "F-14", status: "added" },
